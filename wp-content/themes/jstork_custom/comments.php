...
<h5 id="comments-title" class=""><i class="fa fa-comments-o fa-lg"></i>  <?php comments_number( __( 'コメントはまだありません。', 'moaretrotheme' ), __( '<span>1</span> 件のコメント', 'moaretrotheme' ), __( '<span>%</span> 件のコメント', 'moaretrotheme' ) );?></h5>
