...
<div id="bxslider_custom">
    <ul class="bxslider">
        <li><img class="responsive-img" width="100%" src="<?php echo get_bloginfo('stylesheet_directory').'/bxslider/15154514.jpg'; ?>"/></li>
        <li><img class="responsive-img" width="100%" src="<?php echo get_bloginfo('stylesheet_directory').'/bxslider/28958426.jpg'; ?>"/></li>
    </ul>
</div>
