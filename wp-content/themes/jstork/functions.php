...
function bxslider_js() {
    wp_enqueue_script('jquery.bxslider.min.js', get_bloginfo('stylesheet_directory') . '/bxslider/jquery.bxslider.min.js', array(), false, true );
}
add_action('wp_enqueue_scripts', 'bxslider_js');

function bxslider_css() {
wp_enqueue_style('bxslidercss',get_bloginfo('stylesheet_directory') . '/bxslider/jquery.bxslider.css', array(), null, 'all');
}
